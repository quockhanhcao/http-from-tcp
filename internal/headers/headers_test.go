...
func TestHeadersParse(t *testing.T) {
	...
	// Test: Valid headers that is done parsing
	headers = NewHeaders()
	...
	// Test: host key with lower case and upper case letters
	headers = NewHeaders()
	data = []byte("hOsT: localhost:42069\r\n\r\n")
	n, done, err = headers.Parse(data)
	require.NoError(t, err)
	...
	// Test: Valid multiple values for a single header
	headers = NewHeaders()
